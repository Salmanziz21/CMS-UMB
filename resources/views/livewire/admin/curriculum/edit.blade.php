<div>
    <!-- Header Section -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-foreground">Edit Data Kurikulum</h1>
        <p class="text-secondary mt-1">Perbarui struktur mata kuliah dan beban SKS sesuai kurikulum terbaru.</p>
    </div>
