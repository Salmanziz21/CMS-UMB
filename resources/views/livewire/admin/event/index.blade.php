                        ...
                        <td class="px-4 py-3">
                            <div class="flex justify-center">
                                @if($event->documentation)
                                    @if($event->documentation_exists)
                                        <img
                                            src="{{ asset('storage/' . $event->documentation) }}"
                                            alt="{{ $event->title }}"
                                    ...
                                    @endif
                                    <div class="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center border-2 border-gray-300 dark:border-gray-600 fallback {{ $event->documentation_exists ? 'hidden' : 'flex' }}">
