<div>
    <!-- Header Section -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-foreground">Tambah Profil Lulusan</h1>
        <p class="text-secondary mt-1">Definisikan standar kualitas dan kompetensi lulusan program studi.</p>
    </div>
    ...
    <div class="max-w-4xl">
        <x-form wire:submit.prevent="save" class="relative overflow-hidden">
            ...
            <div class="absolute top-0 right-0 p-8 opacity-[0.03] pointer-events-none">
                <i data-lucide="graduation-cap" class="size-32"></i>
            </div>
